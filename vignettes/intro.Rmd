...
## Overview
sc19011 provides two function to estimate sparse matrix and linear regression with sparse matrices

The JRRS(joint rank and row selection) estimate the regression coefficients with rank restraint.
...
It will return the rank of the regression coefficients.
